        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
                <h4>{{$p->name}}</h4>
                <p class="card-text">{{$p->description}}</p>
                <a class="btn btn-outline-secondary" href="{{$p->link}}" style="font-size: 13px; margin-top: 110px;">Contact</a>
                <a class="btn btn-outline-secondary" href="{{route('dronedetail',["id"=>$p->id])}}" style="font-size: 13px; margin-top: 110px;">See detail</a>
            </div>
          </div>
        </div>
      </div>
